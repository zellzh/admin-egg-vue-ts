...
export class faddTableRoleRights1603420646227 implements MigrationInterface {
  name = 'addTableRoleRights1603420646227';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE `manager_role_rights` ADD CONSTRAINT `FK_f91f7acd4c6afaef5f4cfd86b9d` FOREIGN KEY (`rights_id`) REFERENCES `rights`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION');
    await queryRunner.query('ALTER TABLE `manager_role_rights` ADD CONSTRAINT `FK_9254da4a7108393fb676288b0d9` FOREIGN KEY (`mg_id`) REFERENCES `manager`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION');
  }
