...
export default object.keys({
  username: string.regex(userReg.username).message('用户名格式不正确'),
  phone: string.regex(userReg.phone).message('手机格式不对'),
  email: string.regex(userReg.email).message('邮箱格式不正确'),
